...
public :
   ...
   UInt_t          pfjet_count;
   Float_t         pfjet_e[12];   //[pfjet_count]
   Float_t         pfjet_px[12];   //[pfjet_count]
   Float_t         pfjet_py[12];   //[pfjet_count]
   Float_t         pfjet_pz[12];   //[pfjet_count]
   Float_t         pfjet_pt[12];   //[pfjet_count]
   Float_t         pfjet_eta[12];   //[pfjet_count]
   Float_t         pfjet_phi[12];   //[pfjet_count]
   Float_t         pfjet_neutralhadronicenergy[12];   //[pfjet_count]
   Float_t         pfjet_chargedhadronicenergy[12];   //[pfjet_count]
   Float_t         pfjet_neutralemenergy[12];   //[pfjet_count]
   Float_t         pfjet_chargedemenergy[12];   //[pfjet_count]
   UInt_t          pfjet_chargedmulti[12];   //[pfjet_count]
   UInt_t          pfjet_neutralmulti[12];   //[pfjet_count]
   UInt_t          pfjet_chargedhadronmulti[12];   //[pfjet_count]
   Float_t         pfjet_energycorr[12];   //[pfjet_count]
   Float_t         pfjet_energycorr_l1fastjet[12];   //[pfjet_count]
   Float_t         pfjet_energycorr_l2relative[12];   //[pfjet_count]
   Float_t         pfjet_energycorr_l3absolute[12];   //[pfjet_count]
   Float_t         pfjet_pu_jet_full_mva[12];   //[pfjet_count]
   Int_t           pfjet_flavour[12];   //[pfjet_count]
   Float_t         pfjet_btag[12][10];   //[pfjet_count]
   ...
   Float_t         electron_closestpointx[4];   //[electron_count]
   Float_t         electron_closestpointy[4];   //[electron_count]
   Float_t         electron_closestpointz[4];   //[electron_count]
   ...
   Float_t         electron_mva_id_nontrigPhys14[4];   //[electron_count]
